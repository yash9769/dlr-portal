        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6">
                ...
                <div className="flex items-center gap-4">
                    {/* Progress Card */}
                    {schedule.length > 0 && (
                        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-6 w-full lg:w-auto lg:min-w-[280px]">
            ...
            {yesterdayPending > 0 && (
                <div className="mb-8 p-4 bg-orange-50 border border-orange-200 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 bg-orange-600 font-black text-[10px] text-white uppercase tracking-widest rounded-lg hover:bg-orange-700 transition-colors shadow-lg shadow-orange-100 text-center"
                    >
                        Resolve Now
                    </button>
                </div>
            ...
            {schedule.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {schedule.map((lecture) => (
                        <div key={lecture.id} className="group relative bg-white border border-gray-100 rounded-3xl p-5 sm:p-6 hover:shadow-2xl hover:border-blue-200 transition-all duration-500 flex flex-col justify-between">
                            <div>
