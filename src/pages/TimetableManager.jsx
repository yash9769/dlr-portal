            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-8">
                ...
                <form onSubmit={handleAdd} className="grid grid-cols-1 gap-4 sm:grid-cols-4 lg:grid-cols-6">
                    ...
                    <div className="col-span-1 sm:col-span-4 lg:col-span-6 flex justify-end mt-2">
                        <button type="submit" className="w-full sm:w-auto px-8 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 rounded flex items-center justify-center transition-colors">
